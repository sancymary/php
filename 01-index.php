...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <title>cours PHP -Indroductio</title>
...
<header class="p-5 m-4 bg-light rounded-3 border ">
        <section class="container py-5">
            <h1 class="display-5 fw-bold">01-Introduction au PHP</h1>
  ...
  <footer>
    div.d-flex.justifycontent-evenly.align-items-center bg-dark text-white p3
    <div>
