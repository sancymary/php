...
if(empty($info)){  
   $result= updateAddress($address,$zip,$city,$country,$userId); 
...
<!-- //////////////////////////////////////////////////////////////////////////////// -->
<h1 class="text-center fw-bold text-danger">mon compte</h1>
<div class="w-75 m-auto pt-5 mt-5 regisletre" >
          
          <h2 class="text-center ms-5 p-5">Bonjour <?=($_SESSION['user']['firstName'])?></h2>
          <p>vous voulez changer adresse fait ici</p> 
